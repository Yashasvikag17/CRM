...
export default function Employee() {
  ...
  return (
    <div>
      ...
      <Link to="/dashboard" style={{textDecoration:"none" ,justifyContent:"space-around"}} >        <h6 style={{ margin: '39px 33px 12px 0px', color:"black" }}>  <span style={{margin:"15px"}}><FaArrowLeft/></span>Employee List</h6></Link>
